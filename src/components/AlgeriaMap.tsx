...
// Decorative SVG outline of Algeria's outer border (outer silhouette only).
// Animation: 2x draw/erase loops, then a final draw that stays drawn.
// Baseline strokeDashoffset is always explicit (never undefined) to avoid
// a flash/full-map flicker during the transition between animations.
"use client";
    ...
    >
      <path
        ...
        style={{
          ...
          // Always explicit (never undefined) -> no flash between animation swaps
          strokeDashoffset: phase === "done" ? 0 : PATH_LENGTH,
          animation,
        }}
      />
    </svg>

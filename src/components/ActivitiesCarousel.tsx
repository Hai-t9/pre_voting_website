      ...
      <div className="max-w-container mx-auto px-4 md:px-16 py-16">
        <div className="flex items-center justify-between mb-8">
          <div className="flex flex-col gap-4 mb-10">
            ...
            <h2 className="font-cairo font-extrabold text-2xl md:text-3xl">
              {t("title")}
            </h2>
          </div>
        ...
        >
          {items.map((item, i) => (
            ...
            >
              ...
              <div className="p-4">
                <p className="font-inter text-xs text-charcoal/60 mb-1">
                  {item.year}
                </p>
                <h3 className="font-cairo font-bold text-base mb-2">
                  {item.title}
                </h3>
                <p className="font-plexArabic text-sm text-charcoal/80">
                  {item.description}
                </p>
              </div>
            </div>
